...
public class CommandTest extends CronusCommand {
    ...
    Map<String, Effect> effectMap = Maps.newHashMap();
    ...
    BaseSubCommand condition = new BaseSubCommand() {
        ...
        public Argument[] getArguments() {
            return new Argument[] {new Argument("玩家"), new Argument("表达式")};
        }
        ...
        public void onCommand(CommandSender sender, Command command, String s, String[] args) {
            ...
            Condition parse = conditionMap.computeIfAbsent(ArrayUtil.arrayJoin(args, 1), ConditionParser::parse);
