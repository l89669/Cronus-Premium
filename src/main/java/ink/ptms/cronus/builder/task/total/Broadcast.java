 ...
 */
@Auto
public class Broadcast extends TaskEntry {
    ...
    public ItemStack getItem() {
        return new ItemBuilder(Materials.NAME_TAG.parseMaterial()).name("§f广播事件").lore("", "§7点击选择").flags(ItemFlag.values()).build();
    }

    @Override
    public Class<? extends QuestTask<?>> getTask() {
        return TaskBroadcast.class;
    }
}
